...
using ProCodeGuide.Samples.BrokenAccessControl.DependencyInjection;
...
namespace ProCodeGuide.Samples.BrokenAccessControl
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.Configure<HashIdsOptions>(builder.Configuration.GetSection("Hashids"));
            builder.Services.AddHashids();
